...
- D3.js force-directed 인터랙션 그래프 및 하이퍼링크 단어 이동 브릿징을 통해 사용자가 단어 간 의미 관계망을 시각적으로 탐색, 공유할 수 있는 직관적인 지능형 사전 서비
...
| **데이터 개선 메커니즘** | 없음 | Azure Functions과 크라우드소싱에 기반한 자동 개선 |
...
- D3.js로 2차원 관계형 어휘망을 그래프로 시각화합니다. 중심 단어(파란색), 유의어(노란색), 반의어(빨간색) 노드를 실시간 드래그로 조작하고 노드 클릭을 통해 다른 단어로 즉시 점프할 수 있습니다.
...
- Firebase Auth 기반 Google 소셜 로그인을 제공하며, 단어 즐겨찾기 및 최근 검색 목록을 추적하고 Firestore DB에 실시간 저장합니다.
...
<img align="center" width="484" height="243" alt="image" src="https://github.com/user-attachments/assets/d8c4793b-036a-4ee3-9ea2-8b60783ce7f9" />
...
<img align="center" width="325" height="129" alt="유사도 확장" src="https://github.com/user-attachments/assets/248a82a9-43eb-4735-8650-094016491ed5" /></br>
...
<img width="334" height="179" alt="image" src="https://github.com/user-attachments/assets/b769f093-cb77-4e2a-8172-5a829cefc67a" /></br>
...
graph TD
    ...
    subgraph Durable ["Azure Durable Functions 배치 엔진"]
        DF_Orch["manageCase Durable Orchestrator"]
...
- DNS 레이어에 Cloudflare 프록시를 연결하여 포트 스캐닝 또는 DDoS 대량 트래픽 공격을 차단해 서비스의 가용성 신뢰도를 향상시켰습니다.
